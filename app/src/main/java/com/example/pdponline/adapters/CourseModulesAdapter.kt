...
class CourseModulesAdapter(var onItemClickListener: OnItemClickListener, var course: Course) :
    ListAdapter<Module, CourseModulesAdapter.Vh>(MyDiffUtil()) {
    ...
    inner class Vh(var item_course_modules: ItemModule2Binding) :
        ...
        fun onBind(module: Module, position: Int) {
            ...
            item_course_modules.apply {
                ...
                item_course_modules.courseLogo.setImageURI(Uri.parse(course.pictureUriToString))
